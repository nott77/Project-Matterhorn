...
for (var i = 0; i < size; i++)
{
    ...
    if (inst != noone) //ignore it if the instance is noone
    {
        with (inst)
        {
            ...
            if (!place_meeting(x+xadd, y+yadd, par_solid))
            {
                x += xadd;
                y += yadd;
            }
            ...
            if (!place_meeting(x+xadd, y, par_solid))
            {
                x += xadd;
                ledge_grab = false;
            }
            ...
            if (!place_meeting(x, y+yadd, par_solid))
            {
                y += yadd;
                ledge_grab = false;
            }
            ...
            if (place_meeting(x, y, par_solid))
            {
                ...
                if (other.can_crush)
                {
                    ...
                    //create_effect(mid_x(), mid_y(), sprHitEffect, 0.5); /// DEAL WITH THIS!
                    instance_destroy();
                }
                else
